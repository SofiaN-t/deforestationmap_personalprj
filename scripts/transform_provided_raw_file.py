## Notes ##
# The code in this file is intended to demonstrate how we transform an excel file with geospatial data 
# into a file of geojson format.
# The file is a dummy
...
# The file needs to include a column in a GeoJSON format
...
# sample=gpd.read_file("data\\input\\processed\\processed_export_demo.geojson")
# sample.head()
